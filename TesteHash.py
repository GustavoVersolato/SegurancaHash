...
frasesFornecidas = ['A primeira das instituições criadas pelo Pe. Roberto Sabóia de Medeiros foi a antiga Escola Superior de Administração de Negócios de São Paulo - ESAN/SP.',
...
shaRecebidos = ['d24de3ec3835115c576a55188a31761b73af93ed2c45a171c810bb66b24b08f9',
...
mdRecebidos = ['c850e1a34a6ed572e0758ccd9c615bda',
...
for i in range(10):
        SHA256 = hashlib.sha256(frasesFornecidas[i].encode('utf-8')).hexdigest()
        MD5 = hashlib.md5(frasesFornecidas[i].encode('utf-8')).hexdigest()

        if SHA256 == shaRecebidos[i] and MD5 == mdRecebidos[i] :
                print('A frase na posicao ' + str(i+1) + ' está correta.')
        elif SHA256 != shaRecebidos[i] and MD5 == mdRecebidos[i] :
                print('A frase na posicao ' + str(i+1) + ' está incorreta pois o SHA256 está diferente do esperado.')
                print('o esperado era: '+ str(SHA256))
        elif SHA256 == shaRecebidos[i] and MD5 != mdRecebidos[i] :
                print('A frase na posicao ' + str(i+1) + ' está incorreta pois o MD5 está diferente do esperado.')
                print('o esperado era: '+ str(MD5))
        else : 
               print('Nenhum da frase ' + str(i+1) + ' está correto.')
               print('o esperado para SHA256 era: '+ str(SHA256))
               print('o esperado para MD5 era: '+ str(MD5))
